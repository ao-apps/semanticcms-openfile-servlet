 ...
 */
package com.semanticcms.openfile.servlet.book;
...
@WebServlet("/openfile/servlet/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/openfile/servlet/apidocs/com.semanticcms.openfile.servlet/com" + Objects.toString(req.getPathInfo(), ""),
