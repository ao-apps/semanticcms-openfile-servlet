 ...
 * Copyright (C) 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026  AO Industries, Inc.
...
public final class OpenFile {
   ...
   *
   * <p>TODO: Should this only allow open of published books?</p>
   */
  public static void openFile(
    ...
    if (!isAllowed(servletContext, request)) {
      ...
      if (bookObj.isAccessible()) {
        throw new FileNotFoundException("Book is inaccessible: " + resourceRef);
      }
      ResourceStore resourceStore = bookObj.getResources();
      if (!resourceStore.isAvailable()) {
        throw new FileNotFoundException("Resource store is unavailable: " + resourceRef);
      }
      java.io.File resourceFile = resourceStore.getResource(resourceRef.getPath()).getFile();
      if (resourceFile == null) {
        throw new FileNotFoundException("Resource is not a local file: " + resourceRef);
      }
